      ...
      <div className="w-full max-w-lg relative bg-slate-950/80 border border-slate-800 rounded-2xl p-6 sm:p-8 backdrop-blur-xl shadow-2xl">
        <div className="flex flex-col items-center mb-8">
          <div className="relative mb-3 group">
            <div className="absolute -inset-1.5 bg-gradient-to-r from-amber-500 to-yellow-500 rounded-full blur opacity-30 group-hover:opacity-40 transition duration-1000"></div>
            <img
              src={logoImg}
              alt="BGI Community Logo"
              referrerPolicy="no-referrer"
              className="relative w-24 h-24 rounded-full border border-amber-500/30 object-cover shadow-xl bg-slate-950"
            />
          </div>
